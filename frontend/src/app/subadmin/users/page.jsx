...
const AdminAllUsers = () => {
  ...
  const fetchAllUsers = async () => {
    ...
    try {
      const { data } = await axios.get(
        `${process.env.NEXT_PUBLIC_BACKEND_URL}/api/auth/all`,
      );
  ...
  //       `${process.env.NEXT_PUBLIC_BACKEND_URL}/api/auth/delete/${id}`);
  ...
  const matchesDate =
    !dateFilter || formatDateForInput(user.createdAt) === dateFilter;
              ...
              <div className="p-6">
                <div className="flex flex-col items-center mb-6">
                  {selectedUser.profileImg ? (
                    ...
                    src={`${process.env.NEXT_PUBLIC_BACKEND_URL}/${selectedUser.profileImg}`}
