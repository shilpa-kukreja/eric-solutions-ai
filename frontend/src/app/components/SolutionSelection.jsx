    ...
    <div className="max-w-7xl mx-auto px-6 space-y-15">
      ...
      <div className="grid lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <p className="text-gray-500 mt-4 leading-relaxed text-[17px]">
            ...
            Experience the ease and intuitiveness of our systems, designed to eliminate
            heavy customizations and steep learning curves.
          </p>
        </motion.div>
      ...
      <div className="grid lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <p className="text-gray-500 mt-4 leading-relaxed text-[17px]">
            More than just software—our lab-trained experts provide training and
            guidance to maximize the value of your investment every step of the way.
          </p>
        </motion.div>
      </div>
    </div>
    ...
    <div className="max-w-5xl mx-auto px-8 space-y-20">
      ...
      <div className="flex flex-col items-center text-center">
        ...
        >
          ...
          <p className="text-gray-500 mt-5 leading-relaxed text-[18px]">
            At Eric Solutions, we deliver user-focused solutions that ensure rapid
            results. Experience the ease and intuitiveness of our systems.
          </p>
        </motion.div>
      </div>
      ...
      <div className="flex flex-col items-center text-center">
        ...
        >
          ...
          <p className="text-gray-500 mt-5 leading-relaxed text-[18px]">
            More than just software—our lab-trained experts provide training and
            guidance to maximize the value of your investment.
          </p>
        </motion.div>
      </div>
    </div>
  ...
  <div className="block sm:hidden py-10">
    <div className="max-w-xl mx-auto px-5 space-y-16">
      ...
      <div>
        ...
        >
          <div className="absolute -bottom-3 -right-3 -top-3 w-[190px] h-[270px] bg-orange-400 z-0"></div>
        ...
        >
          ...
          <p className="text-gray-500 mt-4 leading-relaxed text-[15px]">
            At Eric Solutions, we deliver user-focused solutions that ensure rapid
            results and effortless onboarding.
          </p>
        </motion.div>
      </div>
      ...
      <div>
        ...
        >
          ...
          <p className="text-gray-500 mt-4 leading-relaxed text-[15px]">
            More than just software—our experts guide you every step of the way.
          </p>
        </motion.div>
      </div>
    </div>
